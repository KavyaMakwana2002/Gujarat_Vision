...
export const SENTINEL_CAMERAS = [
  ...
  { id: "cam21", name: "Patan Dethali Char Rasta", city: "Patan", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam22", name: "BK Mervada tran Rasta", city: "Banaskantha", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam23", name: "kheram", city: "Kheram", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam24", name: "dehgam", city: "Gandhinagar", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam25", name: "dhanori", city: "Navsari", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam26", name: "TANKAL", city: "Navsari", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam27", name: "bilimora", city: "Navsari", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam28", name: "bilimora", city: "Navsari", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam29", name: "bilimora", city: "Navsari", codec: "H.264", res: "1080p", fps: 30 },
  { id: "cam30", name: "Gandhidham Rambaugh p2", city: "Kutch", codec: "H.264", res: "1080p", fps: 30 },
];
